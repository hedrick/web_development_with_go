...
var (
	...
	ErrRememberRequired modelError = "models: remember token " +
		"is required"
	// ErrRememberTooShort is returned when
...
// UserDB is used to intereact with the users database.
//
...
// nil, ErrNotFound
// Iff the password provided is invalid, this will return
